...
import { fetchTasks } from '../components/TaskList';
  ...
  return (
    <DragDropContext onDragEnd={handleDragEnd}>
                ...
                <Draggable key={column.id} draggableId={column.id.toString()} index={index}>
                  {(provided) => (
                    <div ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
                      <Column column={column} projectId={projectId} />
                    </div>
                  )}
                </Draggable>
              ))}
      ...
      {inputVisible ? (
        ...
        <Button type="default" onClick={handleAddColumn} style={{ marginTop: 16, marginLeft: 20 }}>
